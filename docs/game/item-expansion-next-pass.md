...
| `double_packed_buckle` | Double-Packed Buckle | economy | rare | `onSupplyUsed` | `repeatNextSupply(1)` | Supply build centerpiece. | A heavy two-slot harness buckle with mirrored brass teeth, red pull cords, and a tiny market seal. |
